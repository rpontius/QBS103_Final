...
# I used chat.dartmout.edu for help on merging & flipping row to column for the data frames. It suggested the merge() function and explained how to approach it.
